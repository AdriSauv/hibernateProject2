...
<%@ page import="org.eclipse.*" %>
<%@ page import="java.util.Base64" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<link rel="stylesheet"  type="css" href="css/menuAdmin.css"/>
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarColor02">
		      <ul class="navbar-nav me-auto">
		        <li class="nav-item">
		          <a class="nav-link" href="menuAdmin.jsp">Home
		        ...
		        <li class="nav-item dropdown">
		          <a class="nav-link dropdown-toggle active" data-toggle="dropdown"  role="button" aria-haspopup="true" aria-expanded="false" >Articles</a>
	        ...
	        <%
	            try {
	                ...
	                for (Article article : articles) {
	                    byte[] imageData = article.getImage().getImage();
	        %>
	                    <div class="article-card">
	                        <img class="article-image" src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(imageData) %>" alt="Article Image">
	                        <div class="article-details">
	                            <p class="article-id">ID: <%= article.getIdArticle() %></p>
	                            <p class="article-title">Titre: <%= article.getDesignation() %></p>
	                        </div>
	                    </div>
	        <%
	                }
